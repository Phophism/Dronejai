...
float R_alt = 4.654e-1, Q_alt  = 4.654e-4;  //Q = process noise covariance, R = measurement noise covariance
...
float R_lat = 8.41e-12, Q_lat = 8.5e-14;  //Q = process noise covariance, R = measurement noise covariance
...
float R_lng = 2.209e-11, Q_lng = 2.18e-13;  //Q = process noise covariance, R = measurement noise covariance
