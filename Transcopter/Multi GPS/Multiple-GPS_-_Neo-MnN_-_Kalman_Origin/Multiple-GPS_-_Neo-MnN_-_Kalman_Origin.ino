...
float R_lat[3] = {2.08E-10,2.72E-10,8.41e-12}, Q_lat[3] = {8.5e-14,8.5e-14,8.5e-14}; //Q = process noise covariance, R = measurement noise covariance
...
float R_lng[3] = {1.25E-10,1.48E-10,2.209e-1}, Q_lng[3] = {2.18e-13,2.18e-13,2.18e-13} ;  //Q = process noise covariance, R = measurement noise covariance
